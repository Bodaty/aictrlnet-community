"""Top of the Community test tree: block live third-party egress.

This is the one the container sees: dev-community-1 mounts editions/community/tests
at /app/tests and runs pytest from /app, so the repo-root conftest is absent.
